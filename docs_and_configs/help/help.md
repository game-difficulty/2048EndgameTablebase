...
1. Copy `mistakes_book.pkl` and the `config` file from the `docs_and_configs` folder of the old version.
...
Modify `docs_and_configs/patterns_config.json` to customize table parameters:
