...
| `free10_128` | `C:/2048_tables/free10-128` | `disk-c` | 1 |
| `free10_256` | `C:/2048_tables/free10-256` | `disk-c` | 1 |
| `free10_512` | `C:/2048_tables/free10-512` | `disk-c` | 1 |
| `4421_1024` | `C:/2048_tables/4421` | `disk-c` | 1 |
| `4421_2048` | `C:/2048_tables/4421-2k` | `disk-c` | 1 |
| `2432t_2048` | `C:/2048_tables/2432-2k` | `disk-c` | 1 |
| `444_1024` | `C:/2048_tables/444-1k` | `disk-c` | 1 |
| `444_2048` | `C:/2048_tables/444-2k` | `disk-c` | 1 |
| `LL_1024` | `C:/2048_tables/LL-1k` | `disk-c` | 1 |

`free11` 两张表共享 `disk-d` 的单个槽位；其余本地表共享 `disk-c` 的单个槽位。因此每块磁盘同一时间只执行一次读取。后续迁移数据时只需修改私有配置中的 `path` 和 `resource_group`。
